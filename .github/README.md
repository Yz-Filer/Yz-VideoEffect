...
-c | --fade_in | - | all | ソース画像から徐々にエフェクト画像に変更<br>effect fade in (1-last frame)<br>(source -> effect)
-d | --fade_out | - | all | エフェクト画像から徐々にソース画像に変更<br>effect fade out (1-last frame)<br>(effect -> source)
