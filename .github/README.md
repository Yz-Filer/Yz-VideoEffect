...
## はじめに
Yz-Filerの画像効果をパラメータを指定して静止画 / 動画に対して行うツールです。  
高価なソフトウェアを使わずに手軽に画像効果をつけられるソフトはそんなにないと思います。  
速度改善のためにOpenCVに変更してるので、Yz-Filerとは処理結果が変わってると思います。
...
画像効果の効きが悪い時、画像の幅を500～800くらいに落としてみて下さい。  
解像度が高いと写真っぽく見えやすいです。  
幅や高さを変更した時、  
